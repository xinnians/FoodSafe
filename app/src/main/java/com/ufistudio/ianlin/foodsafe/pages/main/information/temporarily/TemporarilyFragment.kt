...
import kotlinx.android.synthetic.main.fragment_temporarily_list.*

class TemporarilyFragment : InteractionView<OnPageInteractionListener.PrimaryView>() {

    private lateinit var mViewModel: TemporarilyViewModel
    private lateinit var mAdapter: ProductListAdapter
    private var mPosition: Int = 0
    private var mTitle: String = ""

    companion object {
        fun NewInstance(): TemporarilyFragment = TemporarilyFragment()
        private val TAG = TemporarilyFragment::class.simpleName
        const val PAGE_POSITION = "com.example.ianlin.mvvmian.pages.main.information.page_position"
        const val PAGE_TITLE = "com.example.ianlin.mvvmian.pages.main.information.page_title"
    }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        return inflater.inflate(R.layout.fragment_temporarily_list, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mTitle = arguments?.getString(PAGE_TITLE,"")!!
